...
var PropTypes = t.type('PropTypes', t.object(t.property('flat', t.nullable(t.boolean())), t.property('label', t.nullable(t.string()))));


export default (function loginButtonGoogle(_arg) {
  var _PropTypes$assert = PropTypes.assert(_arg),
      flat = _PropTypes$assert.flat,
      label = _PropTypes$assert.label,
